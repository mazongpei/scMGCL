...
Our sample dataset is stored in the directory "data/original/Baron1.h5".

### 2. Generate Preprocessed H5AD File.

```python
python preprocess/preprocess_data.py --input_h5_path="./data/original/Baron1.h5" --save_h5ad_dir="./data/preprocessed/" --filter --norm --log --scale --select_hvg
```

### 3. Apply scMGCL

```python
python main.py --input_h5ad_path="data/preprocessed/Baron1.h5ad" --cluster_num 14 --graph_type KNN --cluster_name kmeans
```
